 ...
 */
static asn_oer_constraints_t asn_OER_type_ASN_XNAP_E_UTRA_Cell_Identity_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	28	/* (SIZE(28..28)) */};
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_E_UTRA_Cell_Identity = {
	...
	sizeof(asn_DEF_ASN_XNAP_E_UTRA_Cell_Identity_tags_1)
		/sizeof(asn_DEF_ASN_XNAP_E_UTRA_Cell_Identity_tags_1[0]), /* 1 */
	{ &asn_OER_type_ASN_XNAP_E_UTRA_Cell_Identity_constr_1, &asn_PER_type_ASN_XNAP_E_UTRA_Cell_Identity_constr_1, ASN_XNAP_E_UTRA_Cell_Identity_constraint },
	0, 0,	/* No members */
