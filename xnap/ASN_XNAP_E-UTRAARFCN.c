 ...
 */
static asn_oer_constraints_t asn_OER_type_ASN_XNAP_E_UTRAARFCN_constr_1 CC_NOTUSED = {
	{ 4, 1 }	/* (0..262143) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_E_UTRAARFCN = {
	...
	sizeof(asn_DEF_ASN_XNAP_E_UTRAARFCN_tags_1)
		/sizeof(asn_DEF_ASN_XNAP_E_UTRAARFCN_tags_1[0]), /* 1 */
	{ &asn_OER_type_ASN_XNAP_E_UTRAARFCN_constr_1, &asn_PER_type_ASN_XNAP_E_UTRAARFCN_constr_1, ASN_XNAP_E_UTRAARFCN_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
