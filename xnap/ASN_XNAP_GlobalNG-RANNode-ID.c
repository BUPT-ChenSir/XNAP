...
static asn_oer_constraints_t asn_OER_type_ASN_XNAP_GlobalNG_RANNode_ID_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_ASN_XNAP_GlobalNG_RANNode_ID_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct ASN_XNAP_GlobalNG_RANNode_ID, choice.choice_extension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_XNAP_ProtocolIE_Single_Container_121P12,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-extension"
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_GlobalNG_RANNode_ID = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_ASN_XNAP_GlobalNG_RANNode_ID_constr_1, &asn_PER_type_ASN_XNAP_GlobalNG_RANNode_ID_constr_1, CHOICE_constraint },
