...
static asn_oer_constraints_t asn_OER_memb_ASN_XNAP_oneframe_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	6	/* (SIZE(6..6)) */};
...
static asn_oer_constraints_t asn_OER_memb_ASN_XNAP_fourframes_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	24	/* (SIZE(24..24)) */};
...
static asn_oer_constraints_t asn_OER_type_ASN_XNAP_MBSFNSubframeAllocation_E_UTRA_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_ASN_XNAP_MBSFNSubframeAllocation_E_UTRA_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_MBSFNSubframeAllocation_E_UTRA, choice.oneframe),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_ASN_XNAP_oneframe_constr_2, &asn_PER_memb_ASN_XNAP_oneframe_constr_2,  memb_ASN_XNAP_oneframe_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_MBSFNSubframeAllocation_E_UTRA, choice.fourframes),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_ASN_XNAP_fourframes_constr_3, &asn_PER_memb_ASN_XNAP_fourframes_constr_3,  memb_ASN_XNAP_fourframes_constraint_1 },
		0, 0, /* No default value */
		"fourframes"
		},
	{ ATF_POINTER, 0, offsetof(struct ASN_XNAP_MBSFNSubframeAllocation_E_UTRA, choice.choice_extension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_XNAP_ProtocolIE_Single_Container_121P23,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-extension"
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_MBSFNSubframeAllocation_E_UTRA = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_ASN_XNAP_MBSFNSubframeAllocation_E_UTRA_constr_1, &asn_PER_type_ASN_XNAP_MBSFNSubframeAllocation_E_UTRA_constr_1, CHOICE_constraint },
