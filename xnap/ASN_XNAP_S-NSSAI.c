...
static asn_oer_constraints_t asn_OER_memb_ASN_XNAP_sst_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	1	/* (SIZE(1..1)) */};
...
static asn_oer_constraints_t asn_OER_memb_ASN_XNAP_sd_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	3	/* (SIZE(3..3)) */};
...
asn_TYPE_member_t asn_MBR_ASN_XNAP_S_NSSAI_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_S_NSSAI, sst),
		...
		0,
		{ &asn_OER_memb_ASN_XNAP_sst_constr_2, &asn_PER_memb_ASN_XNAP_sst_constr_2,  memb_ASN_XNAP_sst_constraint_1 },
	...
	{ ATF_POINTER, 2, offsetof(struct ASN_XNAP_S_NSSAI, sd),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ &asn_OER_memb_ASN_XNAP_sd_constr_3, &asn_PER_memb_ASN_XNAP_sd_constr_3,  memb_ASN_XNAP_sd_constraint_1 },
		0, 0, /* No default value */
		"sd"
		},
	{ ATF_POINTER, 1, offsetof(struct ASN_XNAP_S_NSSAI, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_XNAP_ProtocolExtensionContainer_168P343,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
