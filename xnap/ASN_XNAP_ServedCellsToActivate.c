...
static asn_oer_constraints_t asn_OER_type_ASN_XNAP_ServedCellsToActivate_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_ASN_XNAP_ServedCellsToActivate_constr_1 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_ASN_XNAP_ServedCellsToActivate_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct ASN_XNAP_ServedCellsToActivate, choice.choice_extension),
		...
		&asn_DEF_ASN_XNAP_ProtocolIE_Single_Container_121P70,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-extension"
...
asn_CHOICE_specifics_t asn_SPC_ASN_XNAP_ServedCellsToActivate_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_ServedCellsToActivate = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_ASN_XNAP_ServedCellsToActivate_constr_1, &asn_PER_type_ASN_XNAP_ServedCellsToActivate_constr_1, CHOICE_constraint },
